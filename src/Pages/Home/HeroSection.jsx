...
export default function HeroSection() {
  return (
    <section id="heroSection" className="hero--section">
      <div className="">
        <div className="">
          <p className="">Hey, I'm <br/><h1 className="hero-name">Sahibjot Singh Benipal</h1></p>
        ...
        <a
  href="./SahibCV.pdf"
  download="Sahibjot_Singh_Benipal_Resume.pdf" // This specifies the name of the downloaded file
  target="_blank"
  rel="noopener noreferrer"
  className="downloadR"
>

   Download Resume <FaFileDownload size={20} style={{color:"yellowgreen"}}/>
</a>
        </div>
        <div className="button-container">
      <a
        href="https://github.com/Sahibjotsingh7"
        target="_blank"
        rel="noopener noreferrer"
      ...
      <a
        href="https://leetcode.com/u/SAHIBJOTSINGH22/"
        target="_blank"
        rel="noopener noreferrer"
        className="btn btn-github"
        style={{background:"black", color:"white"}}
      >
        <SiLeetcode size={40} style={{color:"orange"}} />
        <span style={{ fontFamily:"serifS"}}>Leetcode Profile</span>
        
      </a>
      <a
        href="https://www.linkedin.com/in/sahibenipal7/"
        target="_blank"
        rel="noopener noreferrer"
         className="btn btn-github"
        style={{color:"#0a66c2", background:"white"  , fontSize:"25px" }}
      > 
        Linked <FaLinkedin size={40} />
